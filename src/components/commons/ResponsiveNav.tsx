...
//     const userPolls = items.find((i) => i.label === "User Polls");
//     if (userPolls && !base.some((x) => x.to === userPolls.to))
//       base.push(userPolls);
...
//             src={sidebarImgSrc}
//             alt={label}
//             className="h-[3.5rem] w-fit hover:shadow-xl rounded-full hover:scale-110 transition-transform duration-300"
//           />
//         </Link>
//       );
//     }
...
//     // ✅ Normal row with IMAGE icon (Campaigns desktop)
...
//                     className={cn(item.label === "User Polls" && "w-[150px]")}
//                   >
//                     {SidebarRow(item)}
//                   </motion.div>
//                 </React.Fragment>
            ...
            {desktopNavItems
              ...
              .map((item) => (
                <React.Fragment key={item.to}>
                  ...
                  <motion.div
                    variants={sidebarVariants}
                    className={cn(item.label === "Create Campaign" && "2xl:w-[190px] w-[150px]")}
                  >
                    {SidebarRow(item)}
                  </motion.div>
                </React.Fragment>
